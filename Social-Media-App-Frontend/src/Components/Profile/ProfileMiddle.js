...
import img1 from "../../assets/User-post/danh1.1.jpg"
import img2 from "../../assets/User-post/danh1.jpg"
import img3 from "../../assets/User-post/danh2.jpg"
...
const ProfileMiddle = ({following,
  ...
  const [userPostData ,setUserPostData] =useState(
    [
      {
        ...
        body:"Thật ra anh có điều muốn nói, cứ ngập ngùng v thôi ~~, hóa ra a đang nhớ vợ của anh <3",
        like: 22,
        comment:12
    },
    {
    ...
    },
    {
        ...
        body:"ở bên anh liệu rằng có phải bão tố không em :(((",
        like: 340,
        comment:76
    }
    ]
